...
class EnhancedAIService {
  ...
  updateWorkoutContext(context: Partial<WorkoutContext>) {
    ...
    // Adjust emotional tone based on workout intensity
    if (context.intensity === 'high') {
      // AI will be more energetic and motivational
    } else if (context.intensity === 'low') {
      // AI will be more calm and instructional
    }
  }
