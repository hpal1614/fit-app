    ...
    <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
      <div className="flex items-center space-x-3">
        <div className="relative">
          ...
          <div className="absolute -bottom-1 -right-1 bg-gradient-to-r from-purple-600 to-blue-500 text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center border-2 border-[var(--color-background-start)]">
            {user.level}
          </div>
        </div>
        <div>
      ...
      <div className="flex items-center space-x-3 self-end sm:self-center">
        ...
        <button className="relative p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors">
          ...
          <div className="absolute top-1 right-1 w-2 h-2 bg-lime-400 rounded-full ring-2 ring-[var(--color-background-start)]"></div>
        </button>
      </div>
    </header>
  );
