...
export class ConversationFlowService {
  ...
  getQuickReplies(aiMessage: string, scenario: ScenarioType): QuickReply[] {
    ...
    if (
      lower.includes('days per week') ||
      lower.includes('how many days') ||
      lower.includes('days/wk') ||
      lower.includes('days a week')
    ) return this.getFrequencyReplies(scenario);
    ...
    // Fallback: show general options when unsure or feature is unavailable
    return this.getGeneralReplies(scenario);
  }
  ...
  private getFrequencyReplies(_: ScenarioType): QuickReply[] {
    return [
      { id: 'days_3', text: '3 days/wk', value: '3', icon: 'GeneralFitness', category: 'frequency' },
      { id: 'days_4', text: '4 days/wk', value: '4', icon: 'GeneralFitness', category: 'frequency' },
      { id: 'days_5', text: '5 days/wk', value: '5', icon: 'GeneralFitness', category: 'frequency' },
      { id: 'days_6', text: '6 days/wk', value: '6', icon: 'GeneralFitness', category: 'frequency' }
    ];
  }
  ...
  private getGeneralReplies(_: ScenarioType): QuickReply[] {
    return [
      { id: 'gen_program', text: 'Create 8-week Program', value: 'program', icon: 'Strength', category: 'goal' },
      { id: 'gen_nutrition', text: 'Nutrition Plan', value: 'nutrition', icon: 'GeneralFitness', category: 'goal' },
      { id: 'gen_form', text: 'Form Tips', value: 'strength', icon: 'Strength', category: 'goal' },
      { id: 'gen_motivation', text: 'Motivation', value: 'motivation', icon: 'Beginner', category: 'goal' }
    ];
  }
}
