...
export const FireIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M11.75 6c.12-1.25.63-2.5 1.5-3.5A6.37 6.37 0 0 1 21 6c0 6-6 6-6 6s-1.5-1-1.5-3.5c0-.98.24-2.02.75-3" /><path d="M10.13 4.25c.38-.9 1-1.75 2-2.75.24.23.45.48.63.75" /><path d="M18 16c0 4-4 4-4 4s-4-2-4-4c0-2.02 1.25-3.47 2.5-4" /><path d="M9.5 13.5c.66-1.02 1.44-2.22 2.5-3.5" /><path d="M12.5 10.25c.38-.9 1-1.75 2-2.75" /><path d="M7 22a4 4 0 0 1 4-4" />
    </svg>
);
...
export const DropletIcon: React.FC<IconProps & { filled?: boolean }> = ({ className, filled = false }) => (
...
export const UtensilsCrossedIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M15 15 3.3 3.3a4.2 4.2 0 0 0 0 6l7.3 7.3c.7.7 1.8.7 2.5 0l2.3-2.3a3 3 0 0 0 0-4.2l-1.8-1.8a3 3 0 0 0-4.2 0Z"/>
    </svg>
);
...
export const GlassWaterIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M8 21h8" /><path d="M12 15v6" />
        <path d="M10 3h4v12a2 2 0 0 1-2 2h0a2 2 0 0 1-2-2V3Z" />
        <path d="M10 9h4" />
    </svg>
);

export const BottleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M10 5h4" /><path d="M12 19V5" />
        <path d="M8 5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2H8V5Z" />
        <path d="M7 19a4.86 4.86 0 0 0 10 0" />
    </svg>
);

export const FlaskIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M9 2h6" /><path d="M12 9v13" /><path d="M4 9c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V5c0-1.1-.9-2-2-2h-2" />
        <path d="M18 3v2" />
    </svg>
);
...
export const BarbellIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M2 12h20" /><path d="M4 12V6a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v6" /><path d="M16 12V6a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v6" /><path d="M4 12v3a2 2 0 0 0 2 2h0a2 2 0 0 0 2-2v-3" /><path d="M16 12v3a2 2 0 0 0 2 2h0a2 2 0 0 0 2-2v-3" />
    </svg>
);

export const RunningIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <circle cx="6.5" cy="4.5" r="2.5" /><path d="m8.6 7-3.1 6.2" /><path d="m15 13.5-3.5-2-3.5 4" /><path d="m11 10.5 2.5-2.5 5 5" />
    </svg>
);
...
export const PhoneForwardIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <rect x="7" y="2" width="10" height="20" rx="2" ry="2"></rect><path d="M12 18h.01"></path><path d="M17 6.1a5 5 0 0 0-5-2.1 5 5 0 0 0-5 2.1"></path>
    </svg>
);

export const getAchievementIcon = (iconName: string, className?: string) => {
    switch (iconName) {
